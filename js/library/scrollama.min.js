!(function (e, t) {
  ...
  function O(e) {
    if ("string" == typeof e && 0 < e.indexOf("px")) {
      ...
      return isNaN(t)
        ...
        : { format: "pixels", value: t };
    }
    return "number" != typeof e && isNaN(+e)
      ? null
      : (1 < e && err("offset value is greater than 1. Fallback to 1."),
        e < 0 && err("offset value is lower than 0. Fallback to 0."),
        { format: "percent", value: Math.min(Math.max(0, e), 1) });
  }
  let A, N, T;
  function z(e) {
  ...
  return function () {
    let r = {},
      ...
      n = [];
    function x() {
      (r = { stepEnter: () => {}, stepExit: () => {}, stepProgress: () => {} }),
        (n = []);
    }
    function b(e) {
      e && !t && $(), !e && t && y(), (t = e);
    ...
    function s(e, t) {
      ...
      t = { element: e, index: o, progress: t, direction: T };
    ...
    function a([e]) {
      ...
      (t
        ? function (e) {
            var t = q(e);
            const o = f[t];
            (e = { element: e, index: t, direction: T }),
              (o.direction = T),
              (o.state = "enter"),
              n[t] || r.stepEnter(e),
              v && (n[t] = !0);
        ...
        : function (e) {
            ...
            const o = f[t];
            o.state &&
              ((t = { element: e, index: t, direction: T }),
              g &&
                ("down" === T && o.progress < 1
                  ? s(e, 1)
                  : "up" === T && 0 < o.progress && s(e, 0)),
              (o.direction = T),
              (o.state = "exit"),
              r.stepExit(t));
          })(e);
    ...
    function w(e) {
      ...
      s.observe(e.node),
        (e.observers.step = s),
        m && k({ id: i, step: e, marginTop: o, marginBottom: n });
    }
    function e(e) {
      var t = window.innerHeight,
        o = e.offset || p,
        ...
        t = (function (e, t) {
          ...
          const n = [];
          var r = 1 / o;
          for (let e = 0; e < o + 1; e += 1) n.push(e * r);
          return n;
        })(e.height, h);
      const r = new IntersectionObserver(c, { rootMargin: n, threshold: t });
    ...
    return (
        ...
        return (
          ...
          f.length
            ? ((g = r),
              ...
              x(),
              f.forEach((e) =>
                e.node.setAttribute("data-scrollama-index", e.index)
              ),
              b(!0))
            : M("no step elements"),
          S
      ...
      (S.destroy = () => (b(!1), x(), S)),
      (S.resize = () => ($(), S)),
      (S.offset = (e) => (null == e ? p.value : ((p = O(e)), $(), S))),
      (S.onStepEnter = (e) => (
        "function" == typeof e
          ? (r.stepEnter = e)
          : M("onStepEnter requires a function"),
        S
      )),
      (S.onStepExit = (e) => (
        "function" == typeof e
          ? (r.stepExit = e)
          : M("onStepExit requires a function"),
        S
      )),
      (S.onStepProgress = (e) => (
        "function" == typeof e
          ? (r.stepProgress = e)
          : M("onStepProgress requires a function"),
        S
      )),
      S
    );
